...
module.exports.run = async (bot, message, args) => {
    ...
    if (!foundPlayer) {
        ...
        await PlayerCharacter.findOne({ where: { player_id: message.author.id, server_id: message.guild.id, status: "CREATING" } }).then((character) => { if (character) { character.destroy() } });
    }
