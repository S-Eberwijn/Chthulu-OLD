...
exports.getBotEmbed = async function (bot) {
    ...
    return new MessageEmbed()
        ...
        .setDescription(`
        \*\*Cthulhu\*\* is a Great Old One of great power who lies in blah a death-like slumber beneath the \*\*Pacific Ocean\*\* in his sunken city of \*\*R'lyeh\*\*. He remains a dominant presence in the eldrich dealings on our world.
