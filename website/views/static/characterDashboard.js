...
function selectCharacter(characterId) {
    selectCharacterListItem(characterId);
    selectCharacterCard(characterId);
}

function selectCharacterListItem(characterId) {
    let characterListItems = document.querySelectorAll('.characterItem');
    let characterItem = document.getElementById(`listItem-${characterId}`);
    characterListItems.forEach(function (item) {
...
function selectCharacterCard(characterId) {
    let characterCards = document.querySelectorAll('.characterCard');
    let characterCard = document.getElementById(`card-${characterId}`);
